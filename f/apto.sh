...
aptowhen=($(cat $PREFIX/var/log/apt/history.log | grep -E "install |remove " -B1|sed -e "/[()]/d" -e "s/\ \-y//g" -e "s/apt\ //g" -e "s/.*\:\ //"|sed -e "s/install/\x1b[92m&\x1b[0m/g" -e "s/remove/\x1b[91m&\ \x1b[0m/g" | tr -s "\n" " "|sed -e "s/--\ /\n/g" -e "s/[-]/\x1b[2m&\x1b[0m/g" -e "s/[:]/\x1b[35m&\x1b[0m/g")); 
