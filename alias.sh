...
git pull -q; 
printf %b ".";	
git commit -a -m "${USER}_${modo//\ /}_$(date)" &>/dev/null; 
printf %b ".";	
git pull -q; 
printf %b ".";
git push -q; 
...
alias ss='read -eri "sudo $(tail -n1 $HISTFILE)" kk; eval "$kk"'; 
...
alias f='fzf'; 
#[ -e $PREFIX/bin/fastfetch ] && fastfetch || neofetch || return 0'; 
...
alias zz.info.system='fastfetch -c ~/zz/c/fastfetch/fastfetch66.json'; 
